    ...
    for (let i = 0; i < shape.length; i++) {
        for (let j = 0; j < shape[i].length; j++) {
            if (shape[i][j] === 1) {
                ...
                getElement(`cell-${row + i}-${col + j}`).classList.add('test1-red');
            }
        }
    }
}
...
function drawNextPiece(piece) {
    ...
    for (let i = 0; i < shape.length; i++) {
        for (let j = 0; j < shape[i].length; j++) {
            if (shape[i][j] === 1) {
                getElement(`cellNext-${row + i + 1}-${col + j - 2}`).classList.add('test2-orange');
            }
        }
    }
}
...
function undrawPiece(piece) {
    ...
    for (let i = 0; i < shape.length; i++) {
        for (let j = 0; j < shape[i].length; j++) {
            if (shape[i][j] === 1) {
                getElement(`cell-${row + i}-${col + j}`).classList.remove('test1-red');
            }
        }
    }
}
...
function undrawNextPiece(piece) {
    ...
    for (let i = 0; i < cells.length; i++) {
        cells[i].classList.remove('test2-orange');
    }
}
